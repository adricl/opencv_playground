...
def main():
    ...
    imgOriginal = cv2.imread('2016-04-19-204133.jpg', cv2.WINDOW_NORMAL)                     # declare a VideoCapture object and associate to webcam, 0 => use 1st webcam
...
#        circles = cv2.HoughCircles(morph, cv2.HOUGH_GRADIENT, dp, intRows/2)
